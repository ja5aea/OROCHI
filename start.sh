...
cat $apps_dir/sdr_transceiver_hpsdr_orochi/sdr_transceiver_hpsdr.bit > /dev/xdevcfg
...
$apps_dir/sdr_transceiver_hpsdr_orochi/sdr-transceiver-hpsdr-orochi-ananxd 1 2 2 1 1 2 1 2 &
